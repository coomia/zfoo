...
public class CreateNodeASync implements Watcher {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        zookeeper = new ZooKeeper(IP, 5000, new CreateNodeASync());
    ...
    private void doSomething() {
        ...
        zookeeper.create("/node_1", content.getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT, new IStringCallback(), "hello");
    }
