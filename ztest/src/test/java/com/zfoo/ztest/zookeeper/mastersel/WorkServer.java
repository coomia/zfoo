...
public class WorkServer extends LeaderSelectorListenerAdapter implements Closeable {
    ...
    public void start() throws IOException {
        ...
        if (listener != null) {
            try {
                listener.processStart(this.name);
            } catch (Exception e) {
    ...
    public void close() throws IOException {
        ...
        if (listener != null) {
            try {
                listener.processStop(this.name);
            } catch (Exception e) {
    ...
    public void takeLeadership(CuratorFramework client) throws Exception {
        System.out.println(this.name + " take leadership");
        if (listener != null) {
            try {
                listener.processActiveEnter(this.name);
            } catch (Exception e) {
        ...
        try {
            ...
            if (listener != null) {
                try {
                    listener.processActiveExit(this.name);
                } catch (Exception e) {
