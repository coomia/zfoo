...
<script>
import PanThumb from '@/common/component/PanThumb';
import MdInput from '@/common/component/MDinput';
import Mallki from '@/common/component/TextHoverEffect/Mallki';
import DropdownMenu from '@/common/component/Share/dropdownMenu';
import waves from '@/common/directive/waves/index.js'; // 水波纹指令
