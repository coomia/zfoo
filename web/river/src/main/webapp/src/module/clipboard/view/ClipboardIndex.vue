...
<script>
import clip from '@/utils/clipboardUtils'; // use clipboard directly
import clipboard from '../directive/clipboard.js'; // use clipboard by v-directive
...
export default {
    ...
    data() {
        return {
            activeName: 'directly',
            inputData: 'https://github.com/jaysunxiao/zfoo'
        };
    },
    methods: {
